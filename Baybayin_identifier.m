...
message=sprintf('Total number of words found is %d.\nIt consists of %d Baybayin word/s (bounded by red boxes) and \n%d Latin word/s (bounded by blue boxes).',Latin+Baybayin, Baybayin, Latin); %output caption
output2=imshow(a);
hold on
...
annotation('textbox',[0.13 0.09 0.2 0.2], 'String', message,'FitBoxToText','on', 'Edgecolor', 'none'); %you can adjust the textbox position for a better view of the annotation
hold off
%toc;
end
